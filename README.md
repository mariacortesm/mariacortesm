...
- **Diseñadora web multimedia:** Desarrollé desde cero una página web utilizando un CMS, enfocándome en crear interfaces dinámicas y atractivas, centradas en la experiencia de usuario. 
- **Desarrolladora frontend:** Colaboré en el diseño de interfaces y la experiencia de usuario en un proyecto, realizando pruebas de usabilidad y diversas tareas relacionadas con UX y desarrollo web. Adquirí habilidades en Tailwind, Figma y React, lo que me permitió mejorar la interfaz para facilitar el registro y la navegación, haciendo que la página web fuera más intuitiva y accesible para los usuarios.
